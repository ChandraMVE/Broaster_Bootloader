...
baud_setting_t g_uart0_baud_setting =
        {
        /* Baud rate calculated with 0.341% error. */.semr_baudrate_bits_b.abcse = 0,
          .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 5, .mddr = (uint8_t) 228, .semr_baudrate_bits_b.brme =
                  true };
