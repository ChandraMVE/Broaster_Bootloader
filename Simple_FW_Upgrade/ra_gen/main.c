...
#include "task.h"
#include "semphr.h"
extern void led_thread0_create(void);
extern TaskHandle_t led_thread0;
extern void communication_thread0_create(void);
extern TaskHandle_t communication_thread0;
